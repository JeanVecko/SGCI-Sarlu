...
export default function App() {
  ...
  const [clients, setClients] = useState<RealEstateClient[]>(initialRealEstateClients)
  const [categories, setCategories] = useState<Record<string, ApartmentCategory[]>>(() => JSON.parse(JSON.stringify(initialCategories)))
  const [buildingsList, setBuildingsList] = useState<BuildingRecord[]>(() => [...buildings])
